...
public class InstancesUpdater extends Thread {
    ...
    public InstancesUpdater(int accountId, String region) {
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof InstancesUpdater))
            return false;
        InstancesUpdater try1 = (InstancesUpdater)paramObject;
        if (!try1.exists(this))
            return false;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof InstancesUpdater;
    }
    ...
    public String toString() {
        return "InstancesUpdater(accountId=" + getAccountId() + ", region=" + getRegion() + ")";
    }
}
