...
public class Lead extends ActiveRecord implements Serializable {
    ...
    @Column(name = "payout", type = "decimal", nullable = false, length = 50)
    public float payout;
    ...
    public Lead(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("actions");
        setTable("leads");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof Lead))
            return false;
        Lead if1 = (Lead)paramObject;
        if (!if1.exists(this))
            return false;
        if (getId() != if1.getId())
            return false;
        ...
        if ((timestamp1 == null) ? (timestamp2 != null) : !timestamp1.equals(timestamp2))
            return false;
        if (Float.compare(getPayout(), if1.getPayout()) != 0)
            return false;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof Lead;
    }
    ...
    public int hashCode() {
        ...
        n = n * 59 + Float.floatToIntBits(getPayout());
    ...
    public String toString() {
        return "Lead(id=" + getId() + ", uniqueToken=" + getUniqueToken() + ", processId=" + getProcessId() + ", processType=" + getProcessType() + ", userProductionId=" + getUserProductionId() + ", userFullName=" + getUserFullName() + ", vmtaId=" + getVmtaId() + ", smtpUserId=" + getSmtpUserId() + ", affiliateNetworkId=" + getAffiliateNetworkId() + ", offerProductionId=" + getOfferProductionId() + ", listId=" + getListId() + ", clientId=" + getClientId() + ", actionTime=" + getActionTime() + ", payout=" + getPayout() + ", processUpdated=" + isProcessUpdated() + ", agent=" + getAgent() + ", actionIp=" + getActionIp() + ", countryCode=" + getCountryCode() + ", country=" + getCountry() + ", region=" + getRegion() + ", city=" + getCity() + ", deviceType=" + getDeviceType() + ", deviceName=" + getDeviceName() + ", operatingSystem=" + getOperatingSystem() + ", browserName=" + getBrowserName() + ", browserVersion=" + getBrowserVersion() + ")";
    }
}
