...
public class Creative extends ActiveRecord implements Serializable {
    ...
    public Creative() throws Exception {
        setDatabase("system");
        setSchema("affiliate");
        setTable("creatives");
    }

    public Creative(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("affiliate");
        setTable("creatives");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof Creative))
            return false;
        Creative if1 = (Creative)paramObject;
        if (!if1.exists(this))
            return false;
        if (getId() != if1.getId())
            return false;
    ...
    public String toString() {
        return "Creative(id=" + getId() + ", status=" + getStatus() + ", affiliateNetworkId=" + getAffiliateNetworkId() + ", offerId=" + getOfferId() + ", name=" + getName() + ", value=" + getValue() + ", createdBy=" + getCreatedBby() + ", lastUpdatedBy=" + getLastUpdatedBy() + ", createdDate=" + getCreatedDate() + ", lastUpdatedDate=" + getLastUpdatedDate() + ")";
    }
}