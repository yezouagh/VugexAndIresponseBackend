...
public class FromName extends ActiveRecord implements Serializable {
    ...
    @Column(name = "value", type = "text", nullable = false, length = 200)
    public String value;
    ...
    public FromName() throws Exception {
        setDatabase("system");
        setSchema("affiliate");
        setTable("from_names");
    }

    public FromName(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("affiliate");
        setTable("from_names");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof FromName))
            return false;
        FromName for1 = (FromName)paramObject;
        if (!for1.exists(this))
            return false;
        if (getId() != for1.getId())
            return false;
        ...
        if ((str1 == null) ? (str2 != null) : !str1.equals(str2))
            return false;
        if (getAffiliateNetworkId() != for1.getAffiliateNetworkId())
            return false;
        if (getOfferId() != for1.getOfferId())
            return false;
        String str3 = getName();
        String str4 = for1.getName();
        if ((str3 == null) ? (str4 != null) : !str3.equals(str4))
            return false;
        String str5 = getValue();
        String str6 = for1.getValue();
        if ((str5 == null) ? (str6 != null) : !str5.equals(str6))
            return false;
        String str7 = getCreatedBby();
        String str8 = for1.getCreatedBby();
        if ((str7 == null) ? (str8 != null) : !str7.equals(str8))
            return false;
        String str9 = getLastUpdatedBy();
        String str10 = for1.getLastUpdatedBy();
    ...
    protected boolean exists(Object instance) {
        return instance instanceof FromName;
    }
    ...
    public String toString() {
        return "FromName(id=" + getId() + ", status=" + getStatus() + ", affiliateNetworkId=" + getAffiliateNetworkId() + ", offerId=" + getOfferId() + ", name=" + getName() + ", value=" + getValue() + ", createdBy=" + getCreatedBby() + ", lastUpdatedBy=" + getLastUpdatedBy() + ", createdDate=" + getCreatedDate() + ", lastUpdatedDate=" + getLastUpdatedDate() + ")";
    }
}