...
public class MtaProcess extends ActiveRecord implements Serializable {
    ...
    public MtaProcess() throws Exception{
        setDatabase("system");
        setSchema("production");
        setTable("mta_processes");
    }

    public MtaProcess(Object paramObject) throws Exception{
        super(paramObject);
        setDatabase("system");
        setSchema("production");
        setTable("mta_processes");
    ...
    protected boolean exists(Object instance) {
        return instance instanceof MtaProcess;
    }
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof MtaProcess))
            return false;
        MtaProcess if1 = (MtaProcess)paramObject;
        if (!if1.exists(this))
            return false;
        if (getId() != if1.getId())
            return false;
        ...
        String str12 = if1.getLists();
        if ((str11 == null) ? (str12 != null) : !str11.equals(str12))
            return false;
        if (getDelivered() != if1.getDelivered())
            return false;
        if (getHardBounced() != if1.getHardBounced())
            return false;
        if (getSoftBounced() != if1.getSoftBounced())
            return false;
        if (getOpens() != if1.getOpens())
            return false;
        if (getClicks() != if1.getClicks())
            return false;
        if (getLeads() != if1.getLeads())
            return false;
        if (getUnsubs() != if1.getUnsubs())
            return false;
        String str13 = getNegativeFilePath();
        String str14 = if1.getNegativeFilePath();
        if ((str13 == null) ? (str14 != null) : !str13.equals(str14))
            return false;
        String str15 = getContent();
        String str16 = if1.getContent();
