...
public class DigitalOceanAccount extends ActiveRecord implements Serializable {
    ...
    public DigitalOceanAccount() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("digital_ocean_accounts");
    }

    public DigitalOceanAccount(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("digital_ocean_accounts");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof DigitalOceanAccount))
            return false;
        DigitalOceanAccount char1 = (DigitalOceanAccount)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof DigitalOceanAccount;
    }
