...
public class HetznerAccount extends ActiveRecord implements Serializable {
    ...
    public HetznerAccount() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("hetzner_accounts");
    }

    public HetznerAccount(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("hetzner_accounts");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof HetznerAccount))
            return false;
        HetznerAccount switch1 = (HetznerAccount)paramObject;
        ...
        if ((str3 == null) ? (str4 != null) : !str3.equals(str4))
            return false;
        String str5 = getApiKey();
        String str6 = switch1.getApiKey();
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof HetznerAccount;
    }
    ...
    public String toString() {
        return "HetznerAccount(id=" + getId() + ", status=" + getStatus() + ", name=" + getName() + ", apiKey=" + getApiKey() + ", proxyStatus=" + getProxyStatus() + ", proxyIp=" + getProxyIp() + ", proxyPort=" + getProxyPort() + ", proxyUsername=" + getProxyUsername() + ", proxyPassword=" + getProxyPassword() + ", createdBy=" + getCreatedBy() + ", lastUpdatedBy=" + getLastUpdatedBy() + ", createdDate=" + getCreatedDate() + ", lastUpdatedDate=" + getLastUpdatedDate() + ")";
    }
}
