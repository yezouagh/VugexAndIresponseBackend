...
public class AtlanticAccount extends ActiveRecord implements Serializable {
    ...
    @Column(name = "access_key", type = "text", nullable = false)
    ...
    public AtlanticAccount() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("atlantic_accounts");
    }

    public AtlanticAccount(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("atlantic_accounts");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof AtlanticAccount))
            return false;
        AtlanticAccount switch1 = (AtlanticAccount)paramObject;
        ...
        String str6 = switch1.getAccessKey();
        if ((str5 == null) ? (str6 != null) : !str5.equals(str6))
            return false;
        String str = getPrivateKey();
        String sr = switch1.getPrivateKey();
        if ((str == null) ? (sr != null) : !str.equals(sr))
            return false;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof AtlanticAccount;
    }
