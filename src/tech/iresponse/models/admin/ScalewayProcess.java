...
public class ScalewayProcess extends ActiveRecord implements Serializable {
    ...
    public ScalewayProcess() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("scaleway_processes");
    }

    public ScalewayProcess(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("scaleway_processes");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof ScalewayProcess))
            return false;
        ScalewayProcess goto1 = (ScalewayProcess)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof ScalewayProcess;
    }
