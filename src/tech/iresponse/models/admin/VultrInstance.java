...
public class VultrInstance extends ActiveRecord implements Serializable {
    ...
    public VultrInstance() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("vultr_instances");
    }

    public VultrInstance(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("linode_instances");
        load();
    }
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof VultrInstance))
            return false;
        VultrInstance else1 = (VultrInstance)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof VultrInstance;
    }
