...
public class ScalewayInstance extends ActiveRecord implements Serializable {
    ...
    public ScalewayInstance() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("scaleway_instances");
    }

    public ScalewayInstance(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("scaleway_instances");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof ScalewayInstance))
            return false;
        ScalewayInstance else1 = (ScalewayInstance)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof ScalewayInstance;
    }
    ...
    public String toString() {
        return "ScalewayInstance(id=" + getId() + ", status=" + getStatus() + ", instanceId=" + getInstanceId() + ", name=" + getName() + ", accountId=" + getAccountId() + ", accountName=" + getAccountName() + ", mtaServerId=" + getMtaServerId() + ", mtaServerName=" + getMtaServerName() + ", size=" + getSize() + ", platform=" + getPlatform() + ", region=" + getRegion() + ", createdBy=" + getCreatedBy() + ", lastUpdatedBy=" + getLastUpdatedBy() + ", createdDate=" + getCreatedDate() + ", lastUpdatedDate=" + getLastUpdatedDate() + ")";
    }
}
