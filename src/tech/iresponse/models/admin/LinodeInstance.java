...
public class LinodeInstance extends ActiveRecord implements Serializable {
    ...
    public LinodeInstance() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("linode_instances");
    }

    public LinodeInstance(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("linode_instances");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof LinodeInstance))
            return false;
        LinodeInstance else1 = (LinodeInstance)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof LinodeInstance;
    }
