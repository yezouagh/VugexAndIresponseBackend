...
public class AtlanticInstance extends ActiveRecord implements Serializable {
    ...
    public AtlanticInstance() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("atlantic_instances");
    }

    public AtlanticInstance(Object paramObject)throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("atlantic_instances");
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof AtlanticInstance;
    }
