...
public class DigitalOceanDroplet extends ActiveRecord implements Serializable {
    ...
    @Column(name = "droplet_id", type = "text", nullable = false, length = 100)
    ...
    public DigitalOceanDroplet() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("digital_ocean_droplets");
    }

    public DigitalOceanDroplet(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("digital_ocean_droplets");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof DigitalOceanDroplet))
            return false;
        DigitalOceanDroplet else1 = (DigitalOceanDroplet)paramObject;
        ...
        if ((str1 == null) ? (str2 != null) : !str1.equals(str2))
            return false;
        String str3 = getDropletId();
        String str4 = else1.getDropletId();
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof DigitalOceanDroplet;
    }
    ...
    public String toString() {
        return "DigitalOceanDroplet(id=" + getId() + ", status=" + getStatus() + ", dropletId=" + getDropletId() + ", name=" + getName() + ", accountId=" + getAccountId() + ", accountName=" + getAccountName() + ", mtaServerId=" + getMtaServerId() + ", mtaServerName=" + getMtaServerName() + ", size=" + getSize() + ", platform=" + getPlatform() + ", region=" + getRegion() + ", createdBy=" + getCreatedBy() + ", lastUpdatedBy=" + getLastUpdatedBy() + ", createdDate=" + getCreatedDate() + ", lastUpdatedDate=" + getLastUpdatedDate() + ")";
    }
}
