...
public class VultrProcess extends ActiveRecord implements Serializable {
    ...
    public VultrProcess() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("vultr_processes");
    }

    public VultrProcess(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("vultr_processes");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof VultrProcess))
            return false;
        VultrProcess goto1 = (VultrProcess)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof VultrProcess;
    }
