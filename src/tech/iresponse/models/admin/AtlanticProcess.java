...
public class AtlanticProcess extends ActiveRecord implements Serializable {
    ...
    public AtlanticProcess() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("atlantic_processes");
    }

    public AtlanticProcess(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("atlantic_processes");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof HetznerProcess))
            return false;
        HetznerProcess goto1 = (HetznerProcess)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof AtlanticProcess;
    }
