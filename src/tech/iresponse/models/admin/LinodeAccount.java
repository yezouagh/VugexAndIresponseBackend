...
public class LinodeAccount extends ActiveRecord implements Serializable {
    ...
    public LinodeAccount() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("linode_accounts");
    }

    public LinodeAccount(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("linode_accounts");
    ...
    public boolean equals(Object paramObject) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof LinodeAccount))
            return false;
        LinodeAccount char1 = (LinodeAccount)paramObject;
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof LinodeAccount;
    }
