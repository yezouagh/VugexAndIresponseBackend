...
public class HetznerProcess extends ActiveRecord implements Serializable {
    ...
    public HetznerProcess() throws Exception {
        setDatabase("system");
        setSchema("admin");
        setTable("hetzner_processes");
    }

    public HetznerProcess(Object paramObject) throws Exception {
        super(paramObject);
        setDatabase("system");
        setSchema("admin");
        setTable("hetzner_processes");
    ...
    protected boolean exists(Object paramObject) {
        return paramObject instanceof HetznerProcess;
    }
